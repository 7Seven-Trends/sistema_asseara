            ...
            <div class="modal-body" wire:ignore.self>
                <form wire:submit.prevent='salvar' class="row">
                    ...
                    <div class="mb-3 col-3">
                        ...
                        <input type="date" class="form-control" required wire:model.defer="evento.data">
                    </div>
                    <div class="mb-3 col-3">
                        <label class="form-label">Horário</label>
                        <input type="time" class="form-control" required wire:model.defer="evento.horario">
                    </div>
                    <div class="mb-3 col-6">
                    ...
                    <div class="mb-3 col-3">
                        ...
                        <input type="text" class="form-control" maxlength="255" required wire:model.defer="evento.palestrante">
                    </div>
                    <div class="mb-3 col-3">
