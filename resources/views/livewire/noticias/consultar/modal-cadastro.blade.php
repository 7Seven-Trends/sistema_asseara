                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input id="titulo" name="titulo" type="text" placeholder="Insira o título da notícia"
                                    class="form-control" wire:model="titulo" maxlength="100" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="fonte" name="fonte" type="text" placeholder="Fonte da Notícia"
                                    class="form-control" wire:model="fonte" maxlength="100" required>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input id="autor" name="autor" type="text" placeholder="Insira o nome do autor"
                                    class="form-control" wire:model="autor" maxlength="40" required>
                            </div>
                            <div class="mb-3">
                                <label for="publicacaodata">Data de Publicação</label>
                                <input class="form-control" name="publicacao" type="date" id="publicacaodata"
                                    wire:model="publicacao" required max="{{ date('Y-m-d', strtotime('+3years')) }}">
                            </div>
                            <div class="mb-3" wire:ignore>
                    ...
                    <div class="row">
                        <div class="mb-3">
                            ...
                            <input id="resumo" name="resumo" type="text" placeholder="Resumo da Notícia"
                                class="form-control" wire:model="resumo" maxlength="250" required>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="mb-3" wire:ignore>
                            ...
                            <textarea class="form-control" name="conteudo" id="summernote" rows="10" required></textarea>
                        </div>
