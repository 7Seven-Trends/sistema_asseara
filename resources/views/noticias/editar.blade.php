        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="form-cadastro" action="{{ route('painel.noticia.cadastrar') }}" method="POST"
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input id="titulo" name="titulo" type="text" placeholder="Insira o título da notícia"
                                        class="form-control" value="{{ $noticia->titulo }}">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="categoria_id" id="select_categoria" required>
                                        @foreach (\App\Models\Categoria::all() as $categoria)
                                            <option value="{{ $categoria->id }}"
                                                @if ($noticia->categoria_id == $categoria->id) selected @endif>{{ $categoria->nome }}
                                            </option>}
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input id="fonte" name="fonte" type="text" placeholder="Fonte da Notícia"
                                        class="form-control" value="{{ $noticia->fonte }}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input id="autor" name="autor" type="text" placeholder="Insira o nome do autor"
                                        class="form-control" value="{{ $noticia->autor }}" maxlength="40">
                                </div>
                                <div class="mb-3">
                                    <label for="publicacaodata">Data de Publicação</label>
                                    <input class="form-control" name="publicacao" type="date"
                                        value="{{ $noticia->publicacao }}" id="publicacaodata"
                                        max="{{ date('Y-m-d', strtotime('+3years')) }}">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="tags[]" id="select_tag" multiple="multiple">
                                        @foreach (\App\Models\Tag::all() as $tag)
                                            <option value="{{ $tag->id }}"
                                                @if ($noticia->tags->contains($tag->id)) selected @endif>{{ $tag->nome }}
                                            </option>}
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <input id="resumo" name="resumo" type="text" placeholder="Resumo da Notícia"
                                    class="form-control" value="{{ $noticia->resumo }}">
                            </div>
                        </div>
                        <div class="row">
                                        ...
                                        <div
                                            ...
                                            <picture
                                                ...
                                                <img id="thumbnail-preview"
                                                    @if (!$noticia->preview) src="{{ asset('admin/images/thumb-padrao.png') }}" @else src="{{ asset($noticia->preview) }}" @endif
                            ...
                            <div class="col-12 text-center d-flex align-items-center justify-content-center  flex-column">
                                ...
                                <picture
                                    ...
                                    <img id="banner-preview"
                                        @if (!$noticia->banner) src="{{ asset('admin/images/thumb-padrao.png') }}" @else src="{{ asset($noticia->banner) }}" @endif
                                        style="width: 100%; object-fit: cover;" alt="">
                                </picture>
                            </div>
                        </div>
